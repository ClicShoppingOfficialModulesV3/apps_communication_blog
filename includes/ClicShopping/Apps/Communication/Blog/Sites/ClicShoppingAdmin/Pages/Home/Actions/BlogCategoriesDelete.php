<?php
  ...
  class BlogCategoriesDelete extends \ClicShopping\OM\PagesActionsAbstract
  {
    public function execute()
    {
      $CLICSHOPPING_Blog = Registry::get('Blog');

      $this->page->setFile('blog_categories_delete.php');
      $this->page->data['action'] = 'BlogCategoriesDelete';
