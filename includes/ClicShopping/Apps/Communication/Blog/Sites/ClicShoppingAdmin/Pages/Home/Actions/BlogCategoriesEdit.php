<?php
  ...
  class BlogCategoriesEdit extends \ClicShopping\OM\PagesActionsAbstract
  {
    public function execute()
    {
      $CLICSHOPPING_Blog = Registry::get('Blog');

      $this->page->setFile('blog_categories_edit.php');
      $this->page->data['action'] = 'BlogCategoriesEdit';
