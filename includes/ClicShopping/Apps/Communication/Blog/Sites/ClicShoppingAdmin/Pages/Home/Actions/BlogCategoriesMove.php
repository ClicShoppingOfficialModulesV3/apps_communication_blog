<?php
  ...
  class BlogCategoriesMove extends \ClicShopping\OM\PagesActionsAbstract
  {
    public function execute()
    {
      $CLICSHOPPING_Blog = Registry::get('Blog');

      $this->page->setFile('blog_categories_move.php');
      $this->page->data['action'] = 'BlogCategoriesMove';
