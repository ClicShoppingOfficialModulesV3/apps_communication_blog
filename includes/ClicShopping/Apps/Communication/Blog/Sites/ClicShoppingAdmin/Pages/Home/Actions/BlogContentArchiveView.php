<?php
  ...
  class BlogContentArchiveView extends \ClicShopping\OM\PagesActionsAbstract
  {
    public function execute()
    {
      $CLICSHOPPING_Blog = Registry::get('Blog');

      $this->page->setFile('blog_content_archive_view.php');
      $this->page->data['action'] = 'BlogContentArchiveView';
